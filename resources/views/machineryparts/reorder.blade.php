...
<head>
  ...
  <script>
    ...
    function getIdsOfImages() {
                var values = [];
                var news = [];
                var machineryPart = $('#machineryPartId').val();
        ...
        <div class="col-md-6 border border-primary rounded">
            <div class="bd-example p-2">
                ...
                <div class="form-inline">
                    <input type="text" class="form-control"  value={{ $machineryPart->reference }}>
                    <a href="{{ route('machineryparts.show', $machineryPart) }}" class="btn ml-2 btn-primary" id='machineryPartTag'>Volver</a>
                </div>
                @endauth
            </div>
        </div>
...
<div class="container">
    ...
    <div class="mt-4">
        <div class="text-center mb-2">
            ...
            <hr class="mt-2">
            <input type="text" name="machineryPartId" id="machineryPartId" value="{{$machineryPart->id}}" hidden>
        </div>
        @if (!$photos)
        ...
        <div class="m-4 form-inline">
            <form action="#" class="form-inline" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="hidden" name="machineryPart_id" value="{{$machineryPart->id}}">
            ...
            <a class="btn btn-success ml-4" href="{{ route('machineryparts.show',$machineryPart) }}">Volver</a>
